                ...
                <div key={order.id} className="bg-white rounded-lg shadow-sm overflow-hidden">
                  ...
                  <div className="px-6 py-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-gray-600">
                          {order.order_items ? order.order_items.length : 0} {order.order_items && order.order_items.length === 1 ? 'item' : 'items'}
                        </p>
                        <p className="text-sm text-gray-600">
                          Total: <span className="font-semibold text-gray-900">${order.total_amount ? order.total_amount.toFixed(2) : '0.00'}</span>
                        </p>
                      </div>
                        ...
                        {selectedOrder.order_items && selectedOrder.order_items.map((item, index) => (
                          ...
                          >
                            ...
                            <div className="text-right">
                              <p className="text-sm text-gray-600">${item.price ? item.price.toFixed(2) : '0.00'} each</p>
                              <p className="font-semibold text-gray-900">${item.total ? item.total.toFixed(2) : '0.00'}</p>
                            </div>
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="mt-6 bg-white rounded-lg p-4 border border-gray-200">
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">${selectedOrder.total_amount ? (selectedOrder.total_amount * 0.9).toFixed(2) : '0.00'}</span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Tax:</span>
                            <span className="font-medium">${selectedOrder.total_amount ? (selectedOrder.total_amount * 0.1).toFixed(2) : '0.00'}</span>
                          </div>
                          <div className="flex justify-between text-sm">
                          ...
                          <div className="border-t pt-2">
                            <div className="flex justify-between text-lg font-bold">
                              <span>Total:</span>
                              <span className="text-primary-600">${selectedOrder.total_amount ? selectedOrder.total_amount.toFixed(2) : '0.00'}</span>
                            </div>
                          </div>
                        </div>
                      </div>
