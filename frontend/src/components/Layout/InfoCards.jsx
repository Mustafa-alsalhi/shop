      ...
      <div className="container-custom">
        <div className="flex flex-wrap justify-center gap-4 lg:gap-6 xl:gap-8">
          ...
          >
            ...
            <h3 className="font-bold text-lg text-gray-900 mb-2 tracking-tight">من نحن</h3>
            <p className="text-base font-medium text-gray-600 leading-relaxed">اعرف المزيد عن شركتنا</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-bold text-lg text-gray-900 mb-2 tracking-tight">اتصل بنا</h3>
            <p className="text-base font-medium text-gray-600 leading-relaxed">نحن هنا للمساعدة</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-bold text-lg text-gray-900 mb-2 tracking-tight">الأسئلة الشائعة</h3>
            <p className="text-base font-medium text-gray-600 leading-relaxed">احصل على جميع الإجابات</p>
          </Link>
        </div>
      </div>
    </div>
